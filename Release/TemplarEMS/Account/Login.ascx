<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Login.ascx.cs" Inherits="TemplarEMS.Account.Login" %>
<style type="text/css">
    .auto-style1 {
        width: 99%;
        height: 161px;
...
<asp:Panel ID="Panel1" runat="server" Height="165px" Width="494px">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:Label ID="LabelLoginState" runat="server" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="auto-style7">
                <asp:CheckBox ID="CheckBoxRememberMe" runat="server" Font-Size="X-Small" Text="Remember Me?" />
            </td>
